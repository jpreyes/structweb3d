...
![Modo 1 (T = 0.038 s) — primera flexión del voladizo. En gris la geometría sin deformar; en azul la forma modal.](img/1-014_modal_voladizo.svg)
...
| Modo | Descripción | Independiente (s) | SAP2000 (s) | dif. SAP | **Pórtico (s)** | **dif. Pórtico** |
| --- | --- | --- | --- | --- | --- | --- |
