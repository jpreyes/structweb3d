# Verificación 1-010 — Link rígido (offset) — tablero excéntrico sobre pila
...
![Pila deformada bajo la carga del tablero excéntrico (×escala): el momento P·e flexiona la pila lateralmente.](img/1-010_link_offset.svg)
