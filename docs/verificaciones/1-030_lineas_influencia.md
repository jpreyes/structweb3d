# Verificación 1-030 — Líneas de influencia y carga móvil — viga simple
...
**Modelo Pórtico:** [`examples/verif_1-030_lineas_influencia.s3d`](../../examples/verif_1-030_lineas_influencia.s3d)
...
![Viga simplemente apoyada y su pista de carga (6 elementos). La carga unitaria recorre la pista para construir las líneas de influencia.](img/1-030_lineas_influencia.svg)
