...
| **1-018** Bending, shear & axial deformations in a rigid frame | marco rígido; **incluye deformación por corte** | ⭐ valida `timoshenko.js` (Timoshenko vs Euler) |
...
| Caso | Qué prueba | Uso |
|---|---|---|
| **1-014** Frame — eigenvalue (viga en voladizo) | frecuencias de viga | ⭐ verificación modal canónica |
| **1-021** Bathe & Wilson eigenvalue (10 vanos, 9 pisos) | benchmark clásico de subespacio | ⭐⭐ valida `modal_worker` (subespacio) en grande |
...
- **Steel Frame (47)**, **Concrete Frame (42)**, **Cold Formed Steel Frame (17)**, **Design (53)**,
  **Concrete Shell** (ACI-350 diseño), **Vibration / AISC-DG11** (vibración de piso por norma):
  son verificaciones de **diseño por código** (AISC/ACI/EC), no de análisis. ⛔
