...
TORRE DE TRANSMISION / celosia espacial: tipologia:"torre" + torre:{altura_m, base_m (ancho base cuadrada), cima_m (ancho cima), paneles (nº paneles verticales), arriostramiento:"X", rotulado(true=articulada/reticulado|false=nudos rigidos), perfil_montante, perfil_diagonal, crucetas:[{z_m, largo_m (brazo a ±X), carga_vertical_kN (conductor+hielo), carga_transversal_kN (viento sobre el cable)}]}. cargas.viento_kPa = presion de viento sobre la torre (default 0.5). Genera 4 patas conicas + anillos + diagonales en X + apoyos en la base + crucetas. "torre de alta tension de 30m, base 6m, cima 1.5m, 8 paneles, 3 crucetas de 4m a 22/26/30m" -> {"tipologia":"torre","torre":{"altura_m":30,"base_m":6,"cima_m":1.5,"paneles":8,"crucetas":[{"z_m":22,"largo_m":4},{"z_m":26,"largo_m":4},{"z_m":30,"largo_m":4}]}}. Usa "torre" para torres/mastiles de celosia; SOLO usa primitivas si el usuario da coordenadas/conteos explicitos.
PRIMITIVAS (estructura LIBRE, para CUALQUIER cosa sin plantilla: mastiles a medida, parrillas, puentes de N vigas, etc.): tipologia:"primitivas" + material_defecto + elementos[] + apoyos[]. Cada elemento: {tipo:"barra"|"vigas_repetidas", desde:[x,y,z], hasta:[x,y,z] (metros), seccion:{b_cm,h_cm}|"IPE300"|"2x4", material?, n? (subdivisiones), carga_kN_m? (carga lineal vertical)}. vigas_repetidas repite la barra base en paso_dir:"X|Y|Z" cada paso, n_repeticiones (o hasta_coord). apoyos: {en:[[x,y,z],...] o z:0 (toda esa cota), tipo:"empotrado"|"rotulado"|"rodillo"}. Las barras que comparten un punto se unen solas (mismo nodo). Usa primitivas cuando ninguna plantilla encaje, o cuando el usuario da coordenadas/conteos explicitos. Ejemplo puente de 3 vigas (2 laterales + 1 central) de 60m, ancho 8m, transversales cada 2m con 50kN/m, cepas cada 20m, hormigon G40: {"modo":"3D","tipologia":"primitivas","material_defecto":"G40","elementos":[{"tipo":"vigas_repetidas","desde":[0,-4,5],"hasta":[60,-4,5],"paso_dir":"Y","paso":4,"n_repeticiones":3,"seccion":{"b_cm":40,"h_cm":120}},{"tipo":"vigas_repetidas","desde":[0,-4,5],"hasta":[0,4,5],"paso_dir":"X","paso":2,"hasta_coord":60,"seccion":{"b_cm":30,"h_cm":60},"carga_kN_m":50},{"tipo":"vigas_repetidas","desde":[0,-4,0],"hasta":[0,-4,5],"paso_dir":"X","paso":20,"hasta_coord":60,"seccion":{"b_cm":80,"h_cm":80}},{"tipo":"vigas_repetidas","desde":[0,4,0],"hasta":[0,4,5],"paso_dir":"X","paso":20,"hasta_coord":60,"seccion":{"b_cm":80,"h_cm":80}}],"apoyos":[{"z":0,"tipo":"empotrado"}]}.
