...
import { resolveMaterial, clasificarMaterial } from './material_props.js?v=185';
import { resolveSectionProps } from './section_props.js?v=185';
import { registerDesignCode, getDesignCode, defaultCodeFor, setDefaultCode, listDesignCodes } from './registry.js?v=185';
import { aisc360_lrfd, aisc360_asd } from './codes/aisc360.js?v=185';
import { eurocode3 } from './codes/eurocode3.js?v=185';
import { aci318, eurocode2 } from './codes/concrete.js?v=185';
import { timber_nch1198 } from './codes/timber.js?v=185';
import { eurocode9 } from './codes/eurocode9.js?v=185';
