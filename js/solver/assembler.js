...
} from './timoshenko.js?v=116';
import { applyDiaphragmConstraints, applyDiaphragmMass } from './diaphragm.js?v=116';
import { assembleAreasInto, assembleAreasMassInto, areaThermalContribs } from './membrane.js?v=116';
