...
} from './timoshenko.js?v=88';
import { applyDiaphragmConstraints, applyDiaphragmMass } from './diaphragm.js?v=88';
import { assembleAreasInto, areaThermalContribs } from './membrane.js?v=88';
