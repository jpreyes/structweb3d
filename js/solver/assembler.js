...
} from './timoshenko.js?v=112';
import { applyDiaphragmConstraints, applyDiaphragmMass } from './diaphragm.js?v=112';
import { assembleAreasInto, assembleAreasMassInto, areaThermalContribs } from './membrane.js?v=112';
