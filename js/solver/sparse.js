...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=162';
import { applyLinkConstraintsW } from './links.js?v=162';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=162';
