...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=183';
import { applyLinkConstraintsW } from './links.js?v=183';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=183';
