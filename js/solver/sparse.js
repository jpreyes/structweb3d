...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=139';
import { applyLinkConstraintsW } from './links.js?v=139';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=139';
