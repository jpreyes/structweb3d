...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=147';
import { applyLinkConstraintsW } from './links.js?v=147';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=147';
