...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=186';
import { applyLinkConstraintsW } from './links.js?v=186';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=186';
