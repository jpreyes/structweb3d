...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=192';
import { applyLinkConstraintsW } from './links.js?v=192';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=192';
