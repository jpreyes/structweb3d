...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=152';
import { applyLinkConstraintsW } from './links.js?v=152';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=152';
