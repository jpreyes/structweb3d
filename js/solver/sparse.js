...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=163';
import { applyLinkConstraintsW } from './links.js?v=163';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=163';
