...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=149';
import { applyLinkConstraintsW } from './links.js?v=149';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=149';
