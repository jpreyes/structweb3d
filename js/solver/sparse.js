...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=196';
import { applyLinkConstraintsW } from './links.js?v=196';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=196';
