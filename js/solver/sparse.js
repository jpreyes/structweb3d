...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=131';
import { applyLinkConstraintsW } from './links.js?v=131';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=131';
