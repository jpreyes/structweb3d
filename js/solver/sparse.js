...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=154';
import { applyLinkConstraintsW } from './links.js?v=154';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=154';
