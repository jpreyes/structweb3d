...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=129';
import { applyLinkConstraintsW } from './links.js?v=129';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=129';
