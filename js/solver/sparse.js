...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=213';
import { applyLinkConstraintsW } from './links.js?v=213';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=213';
