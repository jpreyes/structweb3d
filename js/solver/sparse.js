...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=171';
import { applyLinkConstraintsW } from './links.js?v=171';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=171';
