...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=199';
import { applyLinkConstraintsW } from './links.js?v=199';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=199';
