...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=157';
import { applyLinkConstraintsW } from './links.js?v=157';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=157';
