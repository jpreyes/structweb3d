...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=132';
import { applyLinkConstraintsW } from './links.js?v=132';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=132';
