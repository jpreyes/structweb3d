...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=150';
import { applyLinkConstraintsW } from './links.js?v=150';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=150';
