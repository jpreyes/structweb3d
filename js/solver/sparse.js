...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=151';
import { applyLinkConstraintsW } from './links.js?v=151';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=151';
