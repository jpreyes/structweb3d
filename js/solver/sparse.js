...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=135';
import { applyLinkConstraintsW } from './links.js?v=135';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=135';
