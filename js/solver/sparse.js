...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=180';
import { applyLinkConstraintsW } from './links.js?v=180';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=180';
