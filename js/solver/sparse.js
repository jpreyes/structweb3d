...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=161';
import { applyLinkConstraintsW } from './links.js?v=161';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=161';
