...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=133';
import { applyLinkConstraintsW } from './links.js?v=133';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=133';
