...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=168';
import { applyLinkConstraintsW } from './links.js?v=168';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=168';
