...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=214';
import { applyLinkConstraintsW } from './links.js?v=214';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=214';
