...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=215';
import { applyLinkConstraintsW } from './links.js?v=215';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=215';
