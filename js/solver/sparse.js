...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=148';
import { applyLinkConstraintsW } from './links.js?v=148';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=148';
