...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=197';
import { applyLinkConstraintsW } from './links.js?v=197';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=197';
