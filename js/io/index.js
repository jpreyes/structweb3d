...
// ──────────────────────────────────────────────────────────────────────────────
export { registerFormat, getFormat, listFormats, exportModel, importModel } from './registry.js?v=197';
export { modelToNeutral, neutralToModel } from './neutral.js?v=197';

// Adaptadores de formato (auto-registro):
import './formats/vector.js?v=197';
import './formats/abaqus.js?v=197';
import './formats/sap2000.js?v=197';
import './formats/etabs.js?v=197';
import './formats/opensees.js?v=197';
import './formats/sofistik.js?v=197';
