...
// ──────────────────────────────────────────────────────────────────────────────
export { registerFormat, getFormat, listFormats, exportModel, importModel } from './registry.js?v=207';
export { modelToNeutral, neutralToModel } from './neutral.js?v=207';

// Adaptadores de formato (auto-registro):
import './formats/vector.js?v=207';
import './formats/abaqus.js?v=207';
import './formats/sap2000.js?v=207';
import './formats/etabs.js?v=207';
import './formats/opensees.js?v=207';
import './formats/sofistik.js?v=207';
