...
// ──────────────────────────────────────────────────────────────────────────────
export { registerFormat, getFormat, listFormats, exportModel, importModel } from './registry.js?v=190';
export { modelToNeutral, neutralToModel } from './neutral.js?v=190';

// Adaptadores de formato (auto-registro):
import './formats/vector.js?v=190';
import './formats/abaqus.js?v=190';
import './formats/sap2000.js?v=190';
import './formats/etabs.js?v=190';
import './formats/opensees.js?v=190';
import './formats/sofistik.js?v=190';
