...
// ──────────────────────────────────────────────────────────────────────────────
export { registerFormat, getFormat, listFormats, exportModel, importModel } from './registry.js?v=196';
export { modelToNeutral, neutralToModel } from './neutral.js?v=196';

// Adaptadores de formato (auto-registro):
import './formats/vector.js?v=196';
import './formats/abaqus.js?v=196';
import './formats/sap2000.js?v=196';
import './formats/etabs.js?v=196';
import './formats/opensees.js?v=196';
import './formats/sofistik.js?v=196';
