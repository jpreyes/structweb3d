...
export default {
  ...
  tendon: { elems: [1, 2, 3, 4], profile: 'parabola', P: 2000, e: { start: 0, mid: 0.4, end: 0 } },

  intro: 'Viga simplemente apoyada de 20 m (4 elementos) con un **tendón parabólico** de fuerza efectiva P = 2000 kN y **sagita a = 0.4 m** al centro (anclado en el centroide en los extremos). Por el método de las **cargas equivalentes**, el tendón ejerce sobre el hormigón una carga uniforme hacia **arriba** w = 8·P·a/L² = **16 kN/m** y una **compresión axial uniforme** P. Se verifica la **contraflecha** de centro (5wL⁴/384EI) y el **axial** de presfuerzo.',
  props: [
    ['Luz', 'L = 20 m (4 × 5 m)'],
  ...
  figure: { caption: () => 'Deformada bajo el solo pretensado (×escala): la viga se arquea hacia ARRIBA (contraflecha), efecto característico del tendón parabólico.' },

  compare: {
    intro: 'Sólo el pretensado actuando (sin carga externa). Contraflecha del centro y axial del primer elemento.',
    unit: '—', decimals: 5, indexLabel: 'Cantidad',
    rows: [
      { idx: '1', desc: 'Contraflecha de centro, nodo 3 · U_z [m] (↑)', indep: 0.01111, sap: 0.01111 },
      { idx: '2', desc: 'Axial de presfuerzo, elem 1 · N [kN] (− = compresión)', indep: -2000.0, sap: -2000.0 },
    ],
    portico: res => [res.getNodeDisp(3)[2], res.getElemForces(1).N],
  },

  extra: `### Balanceo de carga (load balancing)
